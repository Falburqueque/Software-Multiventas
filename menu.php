            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <?php if ($_SESSION['acceso'] == "administradorG") {
                        ...
                        if (file_exists("fotos/CABRAL.png")){
                    echo "<img src='fotos/CABRAL.png' width='180' height='60' alt='Logo Principal' class='dark-logo'>"; 
                            } else {
                    echo "<img src='' width='180' height='60' alt='Logo Principal' class='dark-logo'>"; 
                        ...
                        if (file_exists("fotos/CABRAL".$_SESSION['cuitsucursal'].".png")){
                    echo "<img src='fotos/CABRAL".$_SESSION['cuitsucursal'].".png' width='120' height='60' alt='Logo Principal' class='dark-logo'>"; 
                            } else {
                    echo "<img src='fotos/CABRAL.png' width='180' height='60' alt='Logo Principal' class='dark-logo'>"; 
                            }
                        }
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle waves-effect waves-dark pro-pic d-flex mt-2 pr-0 leading-none simple" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if (isset($_SESSION['dni'])) {
                                    ...
                                    echo "<img src='fotos/CABRAL2.png' width='40' height='40' class='rounded-circle'>"; 
                                    } } else {
                                    echo "<img src='fotos/CABRAL2.png' width='40' height='40' class='rounded-circle'>"; 
                                    }
                                    ?>
                ...
                <?php } ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                                    ...
                                    echo "<img src='fotos/CABRAL2.png' class='rounded-circle' width='80'>"; 
                                    } } else {
                                    echo "<img src='fotos/CABRAL2.png' class='rounded-circle' width='80'>"; 
                                    }
                                ?></div>
